...
module.exports = {
    init() {
        ...
        keyBindings['C-g'] = groupsList.focus.bind(groupsList);     // ctrl-g for groups
        ...
        groupsList.on('keypress', callKeyBindings);
        ...
        groupsList.on('focus', onFocus.bind(null, groupsBox));
        groupsList.on('blur', onBlur.bind(null, groupsBox));
